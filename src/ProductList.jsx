...
function ProductList() {
    ...
    const handleHasCar = (itemName) => {
        let result = false;
        
        if (addedToCart[itemName] == undefined) {
            return result;
        }
                        ...
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                                    ...
                                    <text x="50%" y="50%" text-anchor="middle" dominant-baseline="middle" font-size="64" fill="#faf9f9">
                                    {totalQuantity}
                                    </text>
                                </svg>
                            </h1>
                ...
                <div key={index}>
                    ...
                    <div className="product-list">
                        ...
                        <div className="product-card" key={plantIndex}>
                            ...
                            <button className={`product-button ${handleHasCar(plant.name) ? 'added-to-cart' : ''}`} onClick={() => handleAddToCart(plant)} disabled={handleHasCar(plant.name)}>Add to Cart</button>
                        </div>
                        ))}
                    </div>
                </div>
